...
import me.kobeshow.studyolle.modules.study.form.StudyDescriptionForm;
import me.kobeshow.studyolle.modules.tag.TagRepository;
import me.kobeshow.studyolle.modules.tag.TagService;
...
public class StudySettingController {
    ...
    public String updateStudyPath(@CurrentAccount Account account, @PathVariable String path, @Valid String newPath, Model model, RedirectAttributes attributes) {
        Study study = studyService.getStudyToUpdateStatus(account, path);
