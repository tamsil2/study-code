...
import chapter10.model.Tax;

import java.util.function.DoubleUnaryOperator;

import static chapter10.MixedBuilder.*;

public class TaxCalculator {

    public static double calculate(Order order, boolean useRegional, boolean useGeneral, boolean useSurchange){
    ...
    public static void main(String[] args) {
        ...
        value = new TaxCalculator().with(Tax::regional)
                .with(Tax::surcharge)
                .calculateF(order);
        System.out.printf("Method reference: %.2f%n", value);
    }
}
